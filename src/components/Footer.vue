  ...
  <div class="footer">
    <ul>
      <router-link to="/home" tag="li">
        <div class="nav-img">
          <i class="iconfont icon-yemian" v-if="active == 'home'"></i>
          <i class="iconfont icon-shouye" v-else></i>
        </div>
        <span>首页</span>
      </router-link>
      <router-link to="/category/858" tag="li"
        ><div class="nav-img">
          <i
            class="iconfont icon-leimupinleifenleileibie2"
            v-if="active == 'category/858'"
          ></i>
      ...
      <router-link to="/search" tag="li"
        ><div class="nav-img">
          <i class="iconfont icon-cx" v-if="active == 'search'"></i>
          <i class="iconfont icon-cx" v-else></i>
        </div>
        <span>搜索</span>
      </router-link>
      <router-link to="/cart" tag="li"
        ><div ccartlass="nav-img">
